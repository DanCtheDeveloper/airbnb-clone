...
const jwtSecret = "s2Khw7QHnJvqjQ2XDGmncnyGB"; // Replace with your actual JWT secret
...
app.use(
  cors({
    credentials: true,
    origin: "http://127.0.0.1:4000", // Adjust the allowed origin URL
  })
);
...
async function uploadToS3(path, originalFilename, mimetype) {
  return new Promise(async (resolve, reject) => {
    ...
    resolve(
      `http://jons-test-booking.s3-website-us-east-1.amazonaws.com//${newFileName}`
    );
  });
}
